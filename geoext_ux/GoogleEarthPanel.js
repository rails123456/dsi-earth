...
Ext.define('GeoExt.ux.GoogleEarthPanel', {
    extend: "Ext.Panel",
    alias: 'widget.gxux_googleearthpanel',
    /** api: config[map]
   ...
   // baseUrl: scriptSourceGoogleEarth.replace('/ux/widgets/GoogleEarthPanel.js', ''),
	  baseUrl: scriptSourceGoogleEarth.replace('GeoExt.ux.GoogleEarthPanel.js', ''),
    ...
    afterRender: function() {
        ...
        if (!this.ge) {
            google.earth.createInstance(this.body.dom, Ext.Function.bind(this.initCallback, this), Ext.Function.bind(this.failureCallback, this));
        }
    },
